...
$("#extrasFormSubjectDepartment").change(function () {
    ...
    var semester = document.getElementById("extrasFormSemester").value;
    // get email from localStorage
    var email = localStorage.enteredEmail;
    var auth_token = localStorage.auth_token;
...
// Listen to semester change and call the subject list API
// listen for dropdown list changes
$("#extrasFormSemester").change(function () {
    document.getElementById("extrasFormLoader").style.display = "block";
    document.getElementById("extrasFormNext").setAttribute("disabled", "disabled");
    console.log("change-detected");
    // clear dropdown list
...
extrasForm.addEventListener("submit", e => {
    ...
    localStorage.finalTransactionDepartment = department;
    ...
    $.ajax({
        type: "POST",
        url: "https://xstack.azurewebsites.net/assign-extra-staff.php",
        datatype: "html",
        data: {
            username: email,
            auth_token: auth_token,
