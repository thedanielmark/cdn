// Listen for to-do list
$(document).ready(function () {
  $(function () {
    $('.to-do-list-toggle').on("click", function () {
...
$.ajax({
  type: "POST",
  url: "https://xstack.azurewebsites.net/get-to-do-list.php",
  datatype: "html",
  data: {
    username: username,
...
function deleteToDoItem(id) {
  ...
  $.ajax({
    type: "POST",
    url: "https://xstack.azurewebsites.net/delete-to-do.php",
    datatype: "html",
    data: {
      username: username,
      auth_token: auth_token,
...
function toggleCheckToDoItem(id) {
  ...
  $.ajax({
    type: "POST",
    url: "https://xstack.azurewebsites.net/check-to-do.php",
    datatype: "html",
    data: {
      username: username,
      auth_token: auth_token,
...
toDoForm.addEventListener("submit", e => {
  ...
  $.ajax({
    type: "POST",
    url: "https://xstack.azurewebsites.net/create-to-do.php",
    datatype: "html",
    data: {
      username: username,
      auth_token: auth_token,
