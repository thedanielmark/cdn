...
console.log("%cHello!%cThis is a browser feature intended for developers. Do not enter or paste code which you don't understand. It may allow attackers to steal your information or impersonate you. See https://en.wikipedia.org/wiki/Self-XSS for more details.", "font-size: 40px; color: red; font-weight:bold;", "font-size: 28px;");
...
$(document).ready(function () {
  $('[href=' + '"' + pageName + '"]').parent().addClass("active");
  console.log("Added");
});
